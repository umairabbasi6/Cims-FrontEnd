...
class _AuthApi implements AuthApi {
  ...
  Future<CurrentUser> getMe() async {
    ...
    final _options = _setStreamType<CurrentUser>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CurrentUser _value;
    try {
      _value = CurrentUser.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<MessageResponse> changePassword(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
